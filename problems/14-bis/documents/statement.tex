...
\inputdesc{
  ...
  Depois disso teremos $N$ linhas. Na i\textsuperscript{ésima} delas teremos $M$ números $a_{i, 1}, \ldots, a_{i, M}$ onde $a_{i, j}$ representa o altura do terreno na linha $i$ e coluna $j$ da matriz.

  $N \times M \leq 2\cdot 10^5$, $0 \leq a_{i, j} \leq 10^9$.
}

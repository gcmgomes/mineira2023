...
\inputdesc{A primeira linha contém um inteiro $1 \leq N \leq 5 \times 10^5$. As próximas $N-1$ linhas contém as arestas $1 \leq a_i, b_i \leq N$ da árvore. É garantido que o grafo é uma árvore, e a raiz é o vértice $1$. A próxima linha contém o número de operações $1 \leq Q \leq 5 \times 10^5$. As próximas $Q$ linhas contém 2 inteiros cada, $t, v_i$, em que $t \in \{1, 2, 3\}$ define a operação e $1 \leq v_i \leq N$ o vértice que define a sub-árvore em questão.}

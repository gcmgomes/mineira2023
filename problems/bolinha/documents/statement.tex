...
%
\inputdesc{A primeira linha da entrada consiste em um inteiro $N$ tal que $1 \leq N \leq 2e5$. Depois seguem $N$ linhas, cada uma contendo dois inteiros $A, B$ ($1 \leq A, B \leq 3$), que indica que o copo $A$ foi trocado com o copo $B$.}

...
\inputdesc{A primeira linha contém um inteiro $1 \leq N \leq 10^5$.}
\inputdesc{As próximas $N$ linhas contém dois inteiros separados por um espaço $1 \leq a_i, b_i \leq 10^5$.}

%
% For output, use one of the following
%

\outputdesc{Uma única linha com o menor valor da base $B \geq 2$ tal que nenhum dos $a_i / b_i$ não forma dízima periódica na base $B$, módulo $998\,244\,353$.}
...
\begin{itemize}
\item $1 \leq N \leq 10^5, $1 \leq a_i, b_i \leq 10^5$.
\end{itemize}

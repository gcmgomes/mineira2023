...
Put your statement here, using the macros below.
...
\outputdesc{Output a line containing the uppercase letter \literalchar{Y}
if it is possible to satisfy the bear; otherwise
output the uppercase letter \literalchar{N}.}

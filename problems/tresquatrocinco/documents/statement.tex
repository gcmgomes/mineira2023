...
% Vai ter um triângulo retângulo 3, 4, 5, colocado dentro de uma circunferência tal que o lado de comprimento 4 coincide com o diâmetro. Calcula a área da interseção das do triângulo de do círculo. A entrada é o raio do círculo.

% Tanto faz o tamanho, pode colocar 1 <= R <= 1e5, não sei
